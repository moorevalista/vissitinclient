...
import {
  ...
  SafeAreaView,
  ScrollView,
  TouchableOpacity, TextInput, RefreshControl, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard
} from 'react-native';
...
export default function LayananReservasiPribadi(props) {
  ...
  const [serviceUser, setServiceUser] = useState('pribadi');
  ...
  //tab service user
  const [tabPribadi, setTabPribadi] = useState(true);
  const [tabKerabat, setTabKerabat] = useState(false);
      ...
      serviceUser === 'pribadi' ? (
        ...
        <View style={styles.Checkbox_pribadi}>
          ...
          <Text style={styles.Txt253}>
            Saya mengerti dan memahami bahwa segala layanan yang saya pilih
            dan gunakan adalah untuk kebutuhan saya pribadi.
          </Text>
        </View>
      ) : (
        // isi untuk bagian kerabat
        !tambahKerabat ?
        <>
          ...
          <View style={styles.Checkbox_pribadi}>
            ...
            />
            <Text style={styles.Txt253}>
              Saya mengerti dan memahami bahwa saya akan bertindak sebagai
              wali dari kerabat saya untuk kebutuhan layanan yang saya pilih
              dan gunakan untuk kebutuhan kerabat saya.
            </Text>
          </View>

          <TouchableOpacity style={styles.Btn_layanan1} onPress={() => {
            //setTambahKerabat(true);
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.Layanan_reservasi_pribadi}>
          <View>
            <View style={styles.Tab_pesan}>
              <TouchableOpacity onPress={() => pilihUser('pribadi')}>
                <View style={styles.Group316(tabPribadi)}>
                  <Text style={styles.Txt6110(tabPribadi)}>Pribadi</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => pilihUser('kerabat')}>
                <View style={styles.Group316(tabKerabat)}>
                  <Text style={styles.Txt6110(tabKerabat)}>Kerabat</Text>
                </View>
              </TouchableOpacity>
            </View>
          ...
          {!tambahKerabat ?
              ...
              <TouchableOpacity
                onPress={() =>
                  setujuPribadi
                    ? handleNextReguler('pribadi')
                    : formValidation.showError('pastikan memahami layanan yang di pilih.')
                }>
